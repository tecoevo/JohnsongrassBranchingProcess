%% Generation of data from sexual MGWP (impact of initial density)
% Escape and extinction dynamics of Johnsongrass populations modeled as  
% sexual multiype Galton-Watson process with cross-pollination between 
% all types depending on the initial density.
...
writetable(T1, 'Table_MGWP_Sexual_Avg');
...
% Write table to text file 
writetable(T2, 'Table_MGWP_Sexual');