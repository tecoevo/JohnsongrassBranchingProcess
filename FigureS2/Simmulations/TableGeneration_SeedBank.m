...
for i = 1:n_rep
    ...
    [P, ~, ~, escape, extinct, t_extinct] = ...
        Dynamics_DensityDependance_Sexual(A, p_self, S0, P0, ...
...
writetable(T1, 'Table_MGWP_SeedBankStrength_Sexual');
...
% Write table to text file 
writetable(T2, 'Table_MGWP_WaitingTime_SeedBankStrength_Sexual');