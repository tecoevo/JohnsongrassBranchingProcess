...
Dynamics_Sexual(A, p_self, S0, P0, herbs, n_years, ...
c, k_c, k_h, b, f, d_Z, d_B)
% Dynamics_Sexual gives the dynamics, potential 
% extinction time or escape from control of a Johnsongrass population 
% modelled as a sexual multitype Galton-Watson process over a maximum 
% of n_years years depending on herbicde application, start population
% and different ecological parameters.
%
%   Input: 
%   A: field size
